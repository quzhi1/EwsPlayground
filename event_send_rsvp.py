...
# Respond to an event
event_id = 'AAMkAGY0ODk4NjA1LTc5MWQtNDE0NS1iMmJkLTk5YzYxZjk2NzY5YQFRAAgI3HCEIrRAAEYAAAAAAP1kvVnViEqVb/Ymc6I43gcAqJTRI/07z06lEfGhzXbTqwAAAAABDQAAqJTRI/07z06lEfGhzXbTqwADJR1y3AAAEA=='
event = account.calendar.get(id=event_id)
# event.accept(message_disposition=SEND_ONLY)
