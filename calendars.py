...
exchange_server = 'mail.lobelfinancial.com'
username = os.getenv('LOBELFINANCIAL_USERNAME')
email_address = os.getenv('LOBELFINANCIAL_EMAIL_ADDRESS')
password = os.getenv('LOBELFINANCIAL_PASSWORD')
